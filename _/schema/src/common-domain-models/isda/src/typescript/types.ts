 ...
 */
export interface AccessConditionsElections {
...
export interface AdditionalRegime {
  ...
  regime?: string;
  /**
   * The party elections with respect to the additional regime(s).
   */
 ...
 */
export interface AdditionalRepresentations {
  /**
...
export interface Agreement {
  ...
  /**
   * Elections to specify an Initial Margin Credit Support Annex or Initial Margin Credit Support Deed.
   */
  creditSupportAgreementElections?: CreditSupportAgreementElections;
  /**
   * Security agreement elections.
   */
...
export interface AgreementTerms {
  /**
   * The type of contract being specified
   */
  agreement?: Agreement;
  /**
 ...
 */
export interface BespokeCalculationDate {
  /**
 ...
 */
export interface BespokeCalculationTime {
  /**
 ...
 */
export interface BespokeTransferTiming {
  /**
   * The bespoke transfer timing terms applicable to the agreement
   */
  bespokeTransferTimingTerms?: string;
  /**
...
export interface BondEconomics {
  /**
   * Security: Bond Economics: The terms of the reference rate for calculation of interest on the bond.
   */
  bondInterest?: BondInterestEnum;
  /**
   * Security: Bond Economics: The repayment terms for the principal on the bond.
   */
  bondPrincipal?: BondPrincipalEnum;
  /**
   * Security: Bond Economics: The order of repayment in the event of a sale or bankruptcy of the issuer or a related party (eg guarantor).
   */
...
export interface BondType {
  /**
   * Specification of the characteristics of bond
   */
  bondClass?: BondClassEnum;
  /**
   * Specification of the financial terms of the bond
   */
...
export interface CalculationAgentIm {
  ...
  /**
   * The specification of whether bespoke calculation agent terms are applicable (True) or not (False)
   */
  isApplicable?: boolean;
  /**
 ...
 */
export interface CalculationAndTiming {
  /**
   * The specification of bespoke Calculation Date terms for the purposes of Initial Margin by the parties to the agreement.
   */
  bespokeCalculationDate?: BespokeCalculationDate;
  /**
   * Bespoke terms to describe the time as of which such party (or the Calculation Agent (IM) (if applicable)) computes its end of day valuations of derivatives transactions.
   */
   ...
   */
  collateralValuationAgent?: CollateralValuationAgent;
  /**
...
export interface CollateralProductType {
  ...
  /**
   * The type of collateral product.
   */
 ...
 */
export interface CollateralValuationAgent {
  /**
 ...
 */
export interface CollateralValuationAgentElection {
  /**
...
export interface CollateralValuationPercentage {
  ...
  /**
   * Percentage value of asset to be used as collateral once discounted haircut take into consideration,expressed as a valuation. As an example a 0.5% haircut would be expressed as 99.5% and represented as a decimal number 0.995
   */
...
export interface ConditionsPrecedent {
   ...
   */
  conditionsPrecedentElection?: boolean;
  /**
...
export interface ContractFormationPrimitive {
   ...
   */
  after?: PostContractFormationState;
  /**
 ...
 */
export interface ControlAgreementElections {
  /**
...
export interface CreditSupportAgreementElections {
   ...
   */
  japaneseLawCsa?: OtherAgreements;
  /**
   * The jurisdiction specific terms relevant to the agreement.
   */
  jurisdictionRelatedTerms?: JurisdictionRelatedTerms;
 ...
 * A class to specify the custodian and custody account details for each party to the agreement.
 */
export interface CustodianElection {
  /**
 ...
 */
export interface CustodianRiskElection {
  /**
...
export interface ElectiveAmountElection {
  ...
  party?: string;
  /**
   * A boolean election to express that the elective amount is zero (True) or another value (False).
   */
  zeroAmount?: boolean;
}
 ...
 */
export interface EligibleCollateralCriteria {
  /**
   * Filter based on the issuer.
   */
  issuer?: IssuerCriteria[];
  /**
   * Filter based on the product.
   */
  product?: ProductCriteria[];
  /**
   * Filter based on the valuation percentage or FX haircut percentage.
   */
...
export interface ExecutionLocation {
   ...
   */
  dutyPaymentLanguage?: string;
  /**
   * The execution location of the agreement
   */
  executionLocation?: ExecutionLocationEnum;
  /**
 ...
 */
export interface FloatingInterestRate {
  capRate?: number;
  floorRate?: number;
  /**
 ...
 */
export interface FrenchLawAddendum {
  /**
 ...
 */
export interface FrenchLawAddendumElection {
  /**
   * The party specific language to be included in the agreement.
   */
  addendumLanguage?: string;
  /**
 ...
 */
export interface GeneralSimmElections {
  /**
 ...
 */
export interface IssuerCriteria {
  /**
 ...
 */
export interface JurisdictionRelatedTerms {
  /**
   * Classification of optional exclusive jurisdiction terms
   */
  exclusiveJurisdiction?: boolean;
  /**
...
export interface LegalAgreement extends LegalAgreementBase {
  /**
   * The set of elections specific to the contract
   */
...
export interface NonNegativeQuantitySchedule {
  /**
   * The initial quantity of a schedule represented as a single, non-negative number. In the case where no schedule is specified, the constant quantity is specified at a higher level.
   */
  initialQuantity?: NonNegativeQuantity;
  /**
...
export interface NotificationTime {
   ...
   */
  disputeNotificationReference?: boolean;
  /**
 ...
 */
export interface OtherAgreements {
  /**
 ...
 */
export interface PostingObligations {
  /**
...
export interface ProductCriteria {
   ...
   * Filter based on the issuing entity country of origin.
   */
  productCountryOfOrigin?: FieldWithMeta<String>[];
  /**
   * Filter based on specific instrument identifiers (e.g. specific ISINs, CUSIPs etc).
   */
  productIdentifier?: ProductIdentifier[];
  /**
   * Filter based on whether underlying security is seasoned.
   */
  seasoned?: boolean;
  /**
   * Filter based on whether underlying security is sinkable.
   */
  sinkable?: boolean;
}
...
export interface RegimeTerms {
   ...
   */
  retrospectiveEffect?: RetrospectiveEffect;
  /**
 ...
 */
export interface RetrospectiveEffect {
  /**
...
export interface RightsEvents {
   ...
   */
  securityProviderRightsEvent?: SecurityProviderRightsEvent;
  /**
...
export interface SecurityAgreementElections {
   ...
   */
  enforcementEvent?: EnforcementEvent;
  /**
 ...
 */
export interface SecurityProviderRightsEvent {
  /**
 ...
 * A class to specify party specific Secured Party Rights Event language.
 */
export interface SecurityProviderRightsEventElection {
  /**
   * The elective party.
   */
  party?: string;
 ...
 */
export interface SensitivityMethodologies {
  /**
 ...
 */
export interface SplitPrimitive {
  /**
   * Outcome of the split as a list of Trades, which is either a split execution or a split contract, plus a pointer to the previous execution or contract marked as 'Split'.
   */
  after?: SplitOutcome;
  /**
   * The trade before split, which is either an execution if split happens before the contract is formed, or an already formed contract.
   */
  before?: ReferenceWithMeta<Trade>;
}
 ...
 */
export interface SubstitutedRegimeElection {
  australia?: boolean;
  canada?: boolean;
  cftc?: boolean;
  emir?: boolean;
