<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:tdoc="https://www.metanorma.org/ns/tdoc" xmlns:mathml="http://www.w3.org/1998/Math/MathML" xmlns:xalan="http://xml.apache.org/xalan" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions" version="1.0">
	...
	<xsl:value-of select="/tdoc:tdoc-standard/tdoc:boilerplate/tdoc:copyright-statement/tdoc:clause[1]"/>
	<xsl:text> – All rights reserved</xsl:text>
	</xsl:variable>
		
	<xsl:variable name="color-link">blue</xsl:variable>
	
	<xsl:variable name="doctitle" select="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:title[@language = 'en']"/>

	<xsl:variable name="doctype">
		<xsl:call-template name="capitalizeWords">
			<xsl:with-param name="str" select="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:ext/tdoc:doctype"/>
		</xsl:call-template>
	</xsl:variable>
	
	<xsl:variable name="header">
		<xsl:text>Ribose Whitepaper </xsl:text>
		<xsl:value-of select="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:docidentifier[@type = 'tdoc']"/>
		<xsl:text>:</xsl:text>
		<xsl:value-of select="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:copyright/tdoc:from"/>
	</xsl:variable>
	
	<xsl:variable name="contents">
		<contents>
		
			<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:preface/tdoc:introduction" mode="contents"/>
					
			<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:sections/tdoc:clause[@id='_scope']" mode="contents">
				<xsl:with-param name="sectionNum" select="'1'"/>
			</xsl:apply-templates>
				
			<!-- Normative references  -->
			<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:bibliography/tdoc:references[@id = '_normative_references' or @id = '_references']" mode="contents">
				<xsl:with-param name="sectionNum" select="count(/tdoc:tdoc-standard/tdoc:sections/tdoc:clause[@id='_scope']) + 1"/>
			</xsl:apply-templates>
		
			<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:sections/tdoc:terms" mode="contents"> <!-- Terms and definitions -->
				<xsl:with-param name="sectionNum" select="count(/tdoc:tdoc-standard/tdoc:sections/tdoc:clause[@id='_scope']) +                                      count(/tdoc:tdoc-standard/tdoc:bibliography/tdoc:references[@id = '_normative_references' or @id = '_references']) + 1"/>
			</xsl:apply-templates>
				
			<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:sections/*[local-name() != 'terms' and not(@id='_scope') ]" mode="contents">
				<xsl:with-param name="sectionNumSkew" select="count(/tdoc:tdoc-standard/tdoc:sections/tdoc:clause[@id='_scope']) +                                      count(/tdoc:tdoc-standard/tdoc:bibliography/tdoc:references[@id = '_normative_references' or @id = '_references']) +                                     count(/tdoc:tdoc-standard/tdoc:sections/tdoc:terms)"/>	
			</xsl:apply-templates>
				
			<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:annex" mode="contents"/>
			<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:bibliography/tdoc:references[@id != '_normative_references' and @id != '_references']" mode="contents"/>
						...
						<!-- Dublin Core properties go here -->
							...
							<dc:description>
								<xsl:variable name="abstract">
									<xsl:copy-of select="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:abstract//text()"/>
								</xsl:variable>
			...
			<fo:page-sequence master-reference="document" format="i" force-page-count="end-on-even">
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block font-size="12pt" margin-bottom="12pt">
						...
						<xsl:value-of select="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:edition"/>
					</fo:block>
					
					<fo:block font-size="12pt" margin-bottom="12pt">
						<xsl:call-template name="formatDate">
							<xsl:with-param name="date" select="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:date[@type = 'published']/tdoc:on"/>
						</xsl:call-template>
					</fo:block>
					...
					<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:boilerplate/tdoc:legal-statement"/>
			...
			<fo:page-sequence master-reference="document" format="1" initial-page-number="1" force-page-count="no-force">
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block line-height="130%">
						...
						<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:preface/tdoc:introduction" mode="introduction"/>
					
						<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:sections/tdoc:clause[@id='_scope']">
							<xsl:with-param name="sectionNum" select="'1'"/>
						</xsl:apply-templates>
						
						<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:bibliography/tdoc:references[@id = '_normative_references' or @id = '_references']">
							<xsl:with-param name="sectionNum" select="count(/tdoc:tdoc-standard/tdoc:sections/tdoc:clause[@id='_scope']) + 1"/>
						</xsl:apply-templates>
					
						<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:sections/tdoc:terms"> <!-- Terms and definitions -->
							<xsl:with-param name="sectionNum" select="count(/tdoc:tdoc-standard/tdoc:sections/tdoc:clause[@id='_scope']) +                                         count(/tdoc:tdoc-standard/tdoc:bibliography/tdoc:references[@id = '_normative_references' or @id = '_references']) + 1"/>
						</xsl:apply-templates>
							
						<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:sections/*[local-name() != 'terms' and not(@id='_scope') ]">
							<xsl:with-param name="sectionNumSkew" select="count(/tdoc:tdoc-standard/tdoc:sections/tdoc:clause[@id='_scope']) +                                         count(/tdoc:tdoc-standard/tdoc:bibliography/tdoc:references[@id = '_normative_references' or @id = '_references']) +                                        count(/tdoc:tdoc-standard/tdoc:sections/tdoc:terms)"/>	
						</xsl:apply-templates>
						
						<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:annex"/>
						<xsl:apply-templates select="/tdoc:tdoc-standard/tdoc:bibliography/tdoc:references[@id != '_normative_references' and @id != '_references']"/>
	...
	<xsl:template match="tdoc:tdoc-standard/tdoc:sections/*" mode="contents">
		<xsl:param name="sectionNum"/>
		...
		<xsl:variable name="sectionNum_">
			<xsl:choose>
				...
				<xsl:when test="$sectionNumSkew != 0">
					<xsl:variable name="number"><xsl:number count="tdoc:sections/tdoc:clause[not(@id='_scope') and not(@id='conformance') and not(@id='_conformance')]"/></xsl:variable> <!-- * tdoc:sections/tdoc:clause | tdoc:sections/tdoc:terms -->
	...
	<xsl:template match="tdoc:tdoc-standard/tdoc:sections/tdoc:terms" mode="contents">
		<xsl:param name="sectionNum"/>
		<xsl:param name="sectionNumSkew" select="0"/>
		<xsl:variable name="sectionNum_">
			<xsl:choose>
				<xsl:when test="$sectionNum"><xsl:value-of select="$sectionNum"/></xsl:when>
				<xsl:when test="$sectionNumSkew != 0">
					<xsl:variable name="number"><xsl:number count="*"/></xsl:variable> <!-- tdoc:sections/tdoc:clause | tdoc:sections/tdoc:terms -->
					<xsl:value-of select="$number + $sectionNumSkew"/>
				</xsl:when>
				<xsl:otherwise>
					<xsl:number count="*"/>
	...
	<xsl:template match="tdoc:title | tdoc:preferred" mode="contents">
		<xsl:param name="sectionNum"/>
		...
		<xsl:variable name="display">
			<xsl:choose>
				<xsl:when test="ancestor::tdoc:bibitem">false</xsl:when>
				<xsl:when test="ancestor::tdoc:term">false</xsl:when>
				<xsl:when test="ancestor::tdoc:annex and $level &gt;= 3">false</xsl:when>
		...
		<xsl:variable name="display-section">
			<xsl:choose>
				<xsl:when test="ancestor::tdoc:annex and $level &gt;= 2">true</xsl:when>
				<xsl:when test="ancestor::tdoc:annex">false</xsl:when>
		...
		<xsl:variable name="root">
			<xsl:choose>
				<xsl:when test="ancestor::tdoc:annex">annex</xsl:when>
				<xsl:when test="ancestor::tdoc:clause">clause</xsl:when>
				<xsl:when test="ancestor::tdoc:terms">terms</xsl:when>
			</xsl:choose>
		</xsl:variable>
	...
	<xsl:template match="tdoc:tdoc-standard/tdoc:preface/*" mode="contents">
	...
	<!-- Keywords -->
	<xsl:template match="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:keyword" mode="contents">
		<xsl:param name="sectionNum" select="'1'"/>
		<xsl:variable name="section">
			<xsl:number format="i" value="$sectionNum"/>
		</xsl:variable>
	...
	<xsl:template match="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:contributor[tdoc:role/@type='author']/tdoc:organization/tdoc:name" mode="contents">
		<xsl:param name="sectionNum" select="'1'"/>
		<xsl:variable name="section">
			<xsl:number format="i" value="$sectionNum"/>
		</xsl:variable>
	...
	<xsl:template match="tdoc:figure" mode="contents">
		<xsl:param name="sectionNum"/>
		<item level="" id="{@id}" type="figure">
			<xsl:attribute name="section">
				<xsl:text>Figure </xsl:text>
				<xsl:choose>
					<xsl:when test="ancestor::tdoc:annex">
						<xsl:choose>
							<xsl:when test="count(//tdoc:annex) = 1">
								<xsl:value-of select="/tdoc:nist-standard/tdoc:bibdata/tdoc:ext/tdoc:structuredidentifier/tdoc:annexid"/><xsl:number format="-1" level="any" count="tdoc:annex//tdoc:figure"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:number format="A.1-1" level="multiple" count="tdoc:annex | tdoc:figure"/>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:when>
					<xsl:when test="ancestor::tdoc:figure">
						<xsl:for-each select="parent::*[1]">
							<xsl:number format="1" level="any" count="tdoc:figure[not(parent::tdoc:figure)]"/>
						</xsl:for-each>
						<xsl:number format="-a" count="tdoc:figure"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:number format="1" level="any" count="tdoc:figure[not(parent::tdoc:figure)] | tdoc:sourcecode[not(@unnumbered = 'true') and not(ancestor::tdoc:example)]"/>
						<!-- <xsl:number format="1.1-1" level="multiple" count="tdoc:annex | tdoc:figure"/> -->
					</xsl:otherwise>
				</xsl:choose>
			</xsl:attribute>
			<xsl:value-of select="tdoc:name"/>
		</item>
	</xsl:template>

	
	
	<xsl:template match="tdoc:table[not(@unnumbered='true')]" mode="contents">
		<xsl:param name="sectionNum"/>
		<xsl:variable name="annex-id" select="ancestor::tdoc:annex/@id"/>
		<item level="" id="{@id}" display="false" type="table">
			<xsl:attribute name="section">
				...
				<xsl:choose>
					...
					<xsl:when test="ancestor::*[local-name()='annex']">
						<xsl:number format="A-" count="tdoc:annex"/>
						<xsl:number format="1" level="any" count="tdoc:table[ancestor::tdoc:annex[@id = $annex-id]][not(@unnumbered='true')]"/>
					</xsl:when>
					<xsl:otherwise>
			...
			<xsl:value-of select="tdoc:name/text()"/>
		</item>
	</xsl:template>
	
	
	
	<xsl:template match="tdoc:formula" mode="contents">
		<item level="" id="{@id}" display="false">
			<xsl:attribute name="section">
				<xsl:text>Formula (</xsl:text><xsl:number format="A.1" level="multiple" count="tdoc:annex | tdoc:formula"/><xsl:text>)</xsl:text>
			</xsl:attribute>
		</item>
	</xsl:template>
	
	<xsl:template match="tdoc:fn" mode="contents"/>
	<!-- ============================= -->
	<!-- ============================= -->
	
	<xsl:template match="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:uri[not(@type)]">
		<fo:block margin-bottom="12pt">
			<xsl:text>URL for this tdoc® document: </xsl:text>
			<xsl:value-of select="."/><xsl:text> </xsl:text>
		</fo:block>
	</xsl:template>
	
	<xsl:template match="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:edition">
		<fo:block margin-bottom="12pt">
			<xsl:text>Version: </xsl:text>
			<xsl:value-of select="."/><xsl:text> </xsl:text>
		</fo:block>
	...
	<xsl:template match="tdoc:license-statement//tdoc:title">
		<fo:block text-align="center" font-weight="bold" margin-top="4pt">
			<xsl:apply-templates/>
		</fo:block>
	</xsl:template>
	
	<xsl:template match="tdoc:license-statement//tdoc:p">
		<fo:block font-size="8pt" margin-top="14pt" line-height="115%">
			<xsl:if test="following-sibling::tdoc:p">
	...
	<xsl:template match="tdoc:feedback-statement">
		<fo:block margin-top="12pt" margin-bottom="12pt">
			<xsl:apply-templates select="tdoc:clause[1]"/>
		</fo:block>
	</xsl:template>
		
	<xsl:template match="tdoc:copyright-statement//tdoc:title">
		<fo:block font-weight="bold" text-align="center">
			<xsl:apply-templates/>
		</fo:block>
	</xsl:template>
	<xsl:template match="tdoc:copyright-statement//tdoc:p">
		<fo:block margin-bottom="12pt">
	...
	<xsl:template match="tdoc:legal-statement">
		<xsl:apply-templates/>
	</xsl:template>

	<xsl:template match="tdoc:legal-statement//tdoc:title">
	...
	<!-- Introduction -->
	<xsl:template match="tdoc:tdoc-standard/tdoc:preface/tdoc:introduction" mode="introduction">
		<fo:block break-after="page"/>
		<xsl:apply-templates select="current()"/>
	</xsl:template>
	<!-- Abstract -->
	<xsl:template match="tdoc:tdoc-standard/tdoc:preface/tdoc:abstract" mode="abstract">
		<fo:block break-after="page"/>
		<xsl:apply-templates select="current()"/>
	</xsl:template>
	<!-- Preface -->
	<xsl:template match="tdoc:tdoc-standard/tdoc:preface/tdoc:foreword" mode="preface">
		<xsl:param name="sectionNum"/>
		<fo:block break-after="page"/>
		<xsl:apply-templates select="current()">
			<xsl:with-param name="sectionNum" select="$sectionNum"/>
	...
	<!-- Abstract, Preface -->
	<xsl:template match="tdoc:tdoc-standard/tdoc:preface/*">
		<xsl:param name="sectionNum" select="'1'"/>
		<xsl:if test="not(tdoc:title)">
			<xsl:variable name="id">
				<xsl:choose>
	...
	<!-- Keywords -->
	<xsl:template match="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:keyword">
		<xsl:param name="sectionNum" select="'1'"/>
		...
		<fo:block margin-bottom="12pt">
			...
			<!-- <xsl:for-each select="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:keyword">
				<xsl:value-of select="."/>
	...
	<!-- Submitting Organizations -->
	<xsl:template match="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:contributor[tdoc:role/@type='author']/tdoc:organization/tdoc:name">
		<xsl:param name="sectionNum" select="'1'"/>
		...
		<fo:list-block provisional-distance-between-starts="6.5mm" margin-bottom="12pt" line-height="115%">
			<xsl:for-each select="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:contributor[tdoc:role/@type='author']/tdoc:organization/tdoc:name">
				<fo:list-item>
					<fo:list-item-label end-indent="label-end()">
						<fo:block>—</fo:block>
					</fo:list-item-label>
	...
	<!-- clause, terms, clause, ...-->
	<xsl:template match="tdoc:tdoc-standard/tdoc:sections/*">
		<xsl:param name="sectionNum"/>
		<xsl:param name="sectionNumSkew" select="0"/>
		<fo:block>
			<xsl:variable name="pos"><xsl:number count="tdoc:sections/tdoc:clause[not(@id='_scope') and not(@id='conformance') and not(@id='_conformance')]"/></xsl:variable> <!--  | tdoc:sections/tdoc:terms -->
			<xsl:if test="$pos &gt;= 2">
			...
			<xsl:variable name="sectionNum_">
				<xsl:choose>
					<xsl:when test="$sectionNum"><xsl:value-of select="$sectionNum"/></xsl:when>
					<xsl:when test="$sectionNumSkew != 0">
						<xsl:variable name="number"><xsl:number count="tdoc:sections/tdoc:clause[not(@id='_scope') and not(@id='conformance') and not(@id='_conformance')]"/></xsl:variable> <!--  | tdoc:sections/tdoc:terms -->
						<xsl:value-of select="$number + $sectionNumSkew"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:number count="*"/>
			...
			<xsl:if test="not(tdoc:title)">
				<fo:block margin-top="3pt" margin-bottom="12pt">
					<xsl:value-of select="$sectionNum_"/><xsl:number format=".1 " level="multiple" count="tdoc:clause[not(@id='_scope') and not(@id='conformance') and not(@id='_conformance')]"/>
				</fo:block>
			</xsl:if>
			<xsl:apply-templates>
				<xsl:with-param name="sectionNum" select="$sectionNum_"/>
	...
	<xsl:template match="tdoc:clause//tdoc:clause[not(tdoc:title)]">
		<xsl:param name="sectionNum"/>
		<xsl:variable name="section">
			<xsl:call-template name="getSection">
				<xsl:with-param name="sectionNum" select="$sectionNum"/>
	...
	<xsl:template match="tdoc:title">
		<xsl:param name="sectionNum"/>
		
		<xsl:variable name="parent-name" select="local-name(..)"/>
		<xsl:variable name="references_num_current">
			<xsl:number level="any" count="tdoc:references"/>
		</xsl:variable>
		...
		<xsl:variable name="font-size">
			<xsl:choose>
				<xsl:when test="ancestor::tdoc:preface and $level &gt;= 2">12pt</xsl:when>
				<xsl:when test="ancestor::tdoc:preface">13pt</xsl:when>
				<xsl:when test="$level = 1">13pt</xsl:when>
				<xsl:when test="$level = 2 and ancestor::tdoc:terms">11pt</xsl:when>
	...
	<xsl:template match="tdoc:p">
		...
		<xsl:element name="{$element-name}">
			...
			<xsl:attribute name="text-align">
				<xsl:choose>
					<!-- <xsl:when test="ancestor::tdoc:preface">justify</xsl:when> -->
					<xsl:when test="@align"><xsl:value-of select="@align"/></xsl:when>
			...
			<xsl:attribute name="space-after">
				<xsl:choose>
					<xsl:when test="ancestor::tdoc:li">0pt</xsl:when>
		...
		<xsl:if test="$element-name = 'fo:inline' and not($inline = 'true') and not(local-name(..) = 'admonition')">
			<fo:block margin-bottom="12pt">
				 <xsl:if test="ancestor::tdoc:annex">
	...
	-->
	<xsl:template match="tdoc:title/tdoc:fn | tdoc:p/tdoc:fn[not(ancestor::tdoc:table)]" priority="2">
		<fo:footnote keep-with-previous.within-line="always">
			<xsl:variable name="number" select="@reference"/>
			
			<fo:inline font-size="65%" keep-with-previous.within-line="always" vertical-align="super">
				<fo:basic-link internal-destination="footnote_{@reference}" fox:alt-text="footnote {@reference}">
					<xsl:value-of select="$number"/><!--  + count(//tdoc:bibitem/tdoc:note) -->
				</fo:basic-link>
			</fo:inline>
			<fo:footnote-body>
	...
	<xsl:template match="tdoc:fn/tdoc:p">
		<fo:block>
			<xsl:apply-templates/>
		</fo:block>
	</xsl:template>
	
	<xsl:template match="tdoc:review">
		<!-- comment 2019-11-29 -->
	...
	<xsl:template match="tdoc:image"> <!-- only for without outer figure -->
	...
	<xsl:template match="tdoc:figure">
		...
		<fo:block-container id="{@id}">
			...
			<xsl:for-each select="tdoc:note//tdoc:p">
				...
				<xsl:choose>
					<xsl:when test="ancestor::tdoc:annex">
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:value-of select="$title"/><xsl:number format="A.1-1" level="multiple" count="tdoc:annex | tdoc:figure"/>
							</xsl:otherwise>
						</xsl:choose>
						
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$title"/><xsl:number format="1" level="any" count="tdoc:sourcecode[not(@unnumbered='true') and not(ancestor::tdoc:example)] | tdoc:figure"/>
					</xsl:otherwise>
				</xsl:choose>
				<xsl:if test="tdoc:name">
	...
	<xsl:template match="tdoc:figure/tdoc:name"/>
	<xsl:template match="tdoc:figure/tdoc:fn"/>
	<xsl:template match="tdoc:figure/tdoc:note"/>
	
	
	<xsl:template match="tdoc:figure/tdoc:image">
	...
	<xsl:template match="tdoc:bibitem">
		<fo:block font-family="SourceSansPro" font-size="11pt" id="{@id}" margin-bottom="12pt" start-indent="12mm" text-indent="-12mm">
			...
			<xsl:if test="tdoc:docidentifier">
				<xsl:value-of select="tdoc:docidentifier/@type"/><xsl:text> </xsl:text>
				<xsl:value-of select="tdoc:docidentifier"/>
			</xsl:if>
			<xsl:apply-templates select="tdoc:note"/>
			<xsl:if test="tdoc:docidentifier">, </xsl:if>
			<xsl:choose>
				<xsl:when test="tdoc:formattedref">
					<xsl:apply-templates select="tdoc:formattedref"/>
				</xsl:when>
				<xsl:otherwise>
					<xsl:for-each select="tdoc:contributor[tdoc:role/@type='publisher']/tdoc:organization/tdoc:name">
						<xsl:apply-templates/>
						<xsl:if test="position() != last()">, </xsl:if>
						<xsl:if test="position() = last()">: </xsl:if>
					</xsl:for-each>
					...
					<fo:inline font-style="italic">
						<xsl:choose>
							<xsl:when test="tdoc:title[@type = 'main' and @language = 'en']">
								<xsl:value-of select="tdoc:title[@type = 'main' and @language = 'en']"/><xsl:text>. </xsl:text>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="tdoc:title"/><xsl:text>. </xsl:text>
							</xsl:otherwise>
						</xsl:choose>
					</fo:inline>
					<xsl:for-each select="tdoc:contributor[tdoc:role/@type='publisher']/tdoc:organization/tdoc:name">
					...
					<xsl:if test="tdoc:date[@type='published']/tdoc:on">
						<xsl:text>(</xsl:text><xsl:value-of select="tdoc:date[@type='published']/tdoc:on"/><xsl:text>)</xsl:text>
					</xsl:if>
			</xsl:otherwise>
			</xsl:choose>
		</fo:block>
	...
	<xsl:template match="tdoc:bibitem/tdoc:note">
		<fo:footnote>
			<xsl:variable name="number">
				<xsl:choose>
					<xsl:when test="ancestor::tdoc:references[preceding-sibling::tdoc:references]">
						<xsl:number level="any" count="tdoc:references[preceding-sibling::tdoc:references]//tdoc:bibitem/tdoc:note"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:number level="any" count="tdoc:bibitem/tdoc:note"/>
					</xsl:otherwise>
				</xsl:choose>
			</xsl:variable>
	...
	<xsl:template match="tdoc:references[@id != '_normative_references' and @id != '_references']/tdoc:bibitem">
			...
			<fo:list-item>
				...
				<fo:list-item-body start-indent="body-start()">
					<fo:block>
						<xsl:if test="tdoc:docidentifier">
							<xsl:choose>
								<xsl:when test="tdoc:docidentifier/@type = 'metanorma'"/>
								<xsl:otherwise><fo:inline><xsl:value-of select="tdoc:docidentifier"/>, </fo:inline></xsl:otherwise>
							</xsl:choose>
						</xsl:if>
						<xsl:choose>
							<xsl:when test="tdoc:title[@type = 'main' and @language = 'en']">
								<xsl:apply-templates select="tdoc:title[@type = 'main' and @language = 'en']"/>
							</xsl:when>
							<xsl:otherwise>
								<xsl:apply-templates select="tdoc:title"/>
							</xsl:otherwise>
						</xsl:choose>
						<xsl:apply-templates select="tdoc:formattedref"/>
					</fo:block>
	...
	<xsl:template match="tdoc:ul | tdoc:ol">
		<xsl:choose>
			<xsl:when test="not(ancestor::tdoc:ul) and not(ancestor::tdoc:ol)">
	...
	<xsl:template name="listProcessing">
		<fo:list-block provisional-distance-between-starts="6.5mm">
			<xsl:if test="ancestor::tdoc:ul | ancestor::tdoc:ol">
	...
	<xsl:template match="tdoc:li">
		<fo:list-item>
			<fo:list-item-label end-indent="label-end()">
				<fo:block>
					<xsl:choose>
						<xsl:when test="local-name(..) = 'ul' and (../ancestor::tdoc:ul or ../ancestor::tdoc:ol)">-</xsl:when> <!-- &#x2014; dash -->
	...
	<xsl:template match="tdoc:ul/tdoc:note | tdoc:ol/tdoc:note">
	...
	<xsl:template match="tdoc:preferred">
		<xsl:param name="sectionNum"/>
		<xsl:variable name="section">
			<xsl:call-template name="getSection">
				<xsl:with-param name="sectionNum" select="$sectionNum"/>
	...
	<xsl:template match="tdoc:admitted">
		<fo:block font-size="11pt">
			<xsl:apply-templates/>
		</fo:block>
	</xsl:template>
	
	<xsl:template match="tdoc:deprecates">
		<fo:block>DEPRECATED: <xsl:apply-templates/></fo:block>
	</xsl:template>
	
	<xsl:template match="tdoc:definition[preceding-sibling::tdoc:domain]">
		<xsl:apply-templates/>
	</xsl:template>
	<xsl:template match="tdoc:definition[preceding-sibling::tdoc:domain]/tdoc:p">
		<fo:inline> <xsl:apply-templates/></fo:inline>
		<fo:block> </fo:block>
	</xsl:template>
	
	<xsl:template match="tdoc:definition">
		<fo:block space-after="6pt">
			<xsl:apply-templates/>
		</fo:block>
	</xsl:template>
	
	<xsl:template match="tdoc:termsource">
		<fo:block margin-bottom="12pt" keep-with-previous="always">
			<!-- Example: [SOURCE: ISO 5127:2017, 3.1.6.02] -->
			<fo:basic-link internal-destination="{tdoc:origin/@bibitemid}" fox:alt-text="{tdoc:origin/@citeas}">
				<xsl:text>[SOURCE: </xsl:text>
				<fo:inline text-decoration="underline" color="{$color-link}">
					<xsl:value-of select="tdoc:origin/@citeas"/>
					
					<xsl:apply-templates select="tdoc:origin/tdoc:localityStack"/>
					
				</fo:inline>
			</fo:basic-link>
			<xsl:apply-templates select="tdoc:modification"/>
			<xsl:text>]</xsl:text>
		</fo:block>
	</xsl:template>
	
	<xsl:template match="tdoc:modification">
		<xsl:text>, modified — </xsl:text>
		<xsl:apply-templates/>
	</xsl:template>
	<xsl:template match="tdoc:modification/tdoc:p">
		<fo:inline><xsl:apply-templates/></fo:inline>
	</xsl:template>
	
	<xsl:template match="tdoc:termnote">
	...
	<xsl:template match="tdoc:termnote/tdoc:p">
		<fo:inline><xsl:apply-templates/></fo:inline>
	</xsl:template>
	
	<xsl:template match="tdoc:domain">
		<fo:inline>&lt;<xsl:apply-templates/>&gt;</fo:inline>
	</xsl:template>
	
	
	<xsl:template match="tdoc:termexample">
	...
	<xsl:template match="tdoc:termexample/tdoc:p">
		<fo:inline><xsl:apply-templates/></fo:inline>
	</xsl:template>

	
	<xsl:template match="tdoc:annex">
		<fo:block break-after="page"/>
		<xsl:apply-templates/>
	</xsl:template>
	...
	<!-- [position() &gt; 1] -->
	<xsl:template match="tdoc:references[@id != '_normative_references' and @id != '_references']">
		<fo:block break-after="page"/>
		<fo:block>
			<xsl:apply-templates/>
		</fo:block>
	...
	<xsl:template match="tdoc:references[@id != '_normative_references' and @id != '_references']/tdoc:bibitem" mode="contents"/>
	
	<!-- <xsl:template match="tdoc:references[@id = '_bibliography']/tdoc:bibitem/tdoc:title"> [position() &gt; 1]-->
	<xsl:template match="tdoc:references[@id != '_normative_references' and  @id != '_references']/tdoc:bibitem/tdoc:title">
		<fo:inline font-style="italic">
			<xsl:apply-templates/>
		</fo:inline>
	</xsl:template>

	<xsl:template match="tdoc:quote">
		<fo:block margin-top="12pt" margin-left="13mm" margin-right="12mm">
			<xsl:apply-templates select=".//tdoc:p"/>
		</fo:block>
		<xsl:if test="tdoc:author or tdoc:source">
			<fo:block text-align="right" margin-right="25mm">
				<!-- — ISO, ISO 7301:2011, Clause 1 -->
				<xsl:if test="tdoc:author">
					<xsl:text>— </xsl:text><xsl:value-of select="tdoc:author"/>
				</xsl:if>
				<xsl:if test="tdoc:source">
					<xsl:text>, </xsl:text>
					<xsl:apply-templates select="tdoc:source"/>
				</xsl:if>
			</fo:block>
		</xsl:if>
	</xsl:template>
	
	<xsl:template match="tdoc:source">
		<fo:basic-link internal-destination="{@bibitemid}" fox:alt-text="{@citeas}">
			<xsl:value-of select="@citeas" disable-output-escaping="yes"/>
			<xsl:apply-templates select="tdoc:localityStack"/>
		</fo:basic-link>
	</xsl:template>
	
	
	<xsl:template match="tdoc:xref">
	...
	<xsl:template match="tdoc:sourcecode" priority="2">
		<xsl:call-template name="sourcecode"/>		
		<xsl:choose>
			<xsl:when test="@unnumbered='true'"/>
			<xsl:when test="ancestor::tdoc:example"/>
			<xsl:when test="ancestor::tdoc:td"/>
			<xsl:when test="ancestor::tdoc:annex">
				<xsl:variable name="id_annex" select="ancestor::tdoc:annex/@id"/>
				<xsl:choose>
					<xsl:when test="count(//tdoc:annex) = 1">
						<xsl:value-of select="/tdoc:nist-standard/tdoc:bibdata/tdoc:ext/tdoc:structuredidentifier/tdoc:annexid"/><xsl:number format="-1" level="any" count="tdoc:annex//tdoc:sourcecode"/>
					</xsl:when>
					<xsl:otherwise>
						<fo:block font-family="SourceSansPro" font-size="12pt" font-weight="bold" text-align="center" margin-bottom="12pt">
							<xsl:text>Figure </xsl:text>
							<xsl:number format="A." level="multiple" count="tdoc:annex"/>
							<xsl:number format="1" level="any" count="tdoc:sourcecode[ancestor::tdoc:annex/@id = $id_annex and not(@unnumbered='true') and not(ancestor::tdoc:example)]"/>
							<xsl:if test="tdoc:name">
								<xsl:text> — </xsl:text>
								<xsl:apply-templates select="tdoc:name/node()"/>
							</xsl:if>
						</fo:block>
					</xsl:otherwise>
				</xsl:choose>
			...
			<xsl:otherwise>
				<fo:block font-family="SourceSansPro" font-size="12pt" font-weight="bold" text-align="center" margin-bottom="12pt">
					<xsl:text>Figure </xsl:text>
					<xsl:number format="1" level="any" count="tdoc:sourcecode[not(@unnumbered='true') and not(ancestor::tdoc:example)] | tdoc:figure"/>
					<xsl:if test="tdoc:name">
						<xsl:text> — </xsl:text>
						<xsl:apply-templates select="tdoc:name/node()"/>
					</xsl:if>
	...
	<xsl:template match="tdoc:sourcecode/text()">
	...
	<xsl:template match="tdoc:sourcecode/tdoc:name"/>
	
	<xsl:template match="tdoc:tt" priority="2">
		<fo:inline font-family="SourceCodePro" font-size="10pt">
			<xsl:apply-templates/>
		</fo:inline>
	</xsl:template>
	
	<xsl:template match="tdoc:example">
		<fo:block font-family="SourceSansPro" font-size="11pt" margin-top="12pt" margin-bottom="12pt" font-weight="bold" keep-with-next="always">
			...
			<xsl:choose>
				<xsl:when test="following-sibling::tdoc:example or preceding-sibling::tdoc:example">
					<xsl:number format=" 1"/>
				</xsl:when>
				<xsl:when test="local-name(ancestor::*[1]) = 'li' and count(ancestor::tdoc:ol//tdoc:example) &gt; 0">
					<xsl:variable name="list_id" select="ancestor::tdoc:ol[1]/@id"/>
					<xsl:number format=" 1" count="tdoc:example[ancestor::tdoc:ol[1][@id = $list_id]]" level="any"/>
				</xsl:when>
				<xsl:when test="local-name(ancestor::*[1]) = 'li' and count(ancestor::tdoc:ul//tdoc:example) &gt; 0">
					<xsl:variable name="list_id" select="ancestor::tdoc:ul[1]/@id"/>
					<xsl:number format=" 1" count="tdoc:example[ancestor::tdoc:ul[1][@id = $list_id]]" level="any"/>
				</xsl:when>
			</xsl:choose>
	...
	<xsl:template match="tdoc:example/tdoc:name"/>
	
	<xsl:template match="tdoc:example/tdoc:p">
	...
	<xsl:template match="tdoc:note/tdoc:p" name="note">
		<fo:block font-size="10pt" margin-top="12pt" margin-bottom="12pt" line-height="115%">
			<xsl:if test="ancestor::tdoc:ul or ancestor::tdoc:ol and not(ancestor::tdoc:note[1]/following-sibling::*)">
				<xsl:attribute name="margin-bottom">0pt</xsl:attribute>
			</xsl:if>
			<xsl:variable name="clauseid" select="ancestor::tdoc:clause[1]/@id"/>
			<fo:inline padding-right="4mm">
				<xsl:text>NOTE </xsl:text>
				<xsl:if test="count(//tdoc:note[ancestor::tdoc:clause[1][@id = $clauseid]]) &gt; 1">
					<xsl:number count="tdoc:note[ancestor::tdoc:clause[1][@id = $clauseid]]" level="any"/>
				</xsl:if>
			</fo:inline>
			<xsl:apply-templates/>
		</fo:block>
		...
		<fo:basic-link internal-destination="{@bibitemid}" fox:alt-text="{@citeas}" text-decoration="underline" color="{$color-link}"> <!-- font-size="9pt" color="blue" vertical-align="super" -->
			...
			<xsl:choose>
				...
				<xsl:when test="@bibitemid and normalize-space(text()) = ''">
					<xsl:value-of select="//tdoc:bibitem[@id = current()/@bibitemid]/tdoc:docidentifier"/>
				</xsl:when>
				<xsl:otherwise/>
			</xsl:choose>
			<xsl:apply-templates select="tdoc:localityStack"/>
	...
	<xsl:template match="tdoc:locality">
		<xsl:choose>
			<xsl:when test="@type ='clause'">Clause </xsl:when>
			<xsl:when test="@type ='annex'">Annex </xsl:when>
			<xsl:otherwise><xsl:value-of select="@type"/></xsl:otherwise>
		</xsl:choose>
		<xsl:text> </xsl:text><xsl:value-of select="tdoc:referenceFrom"/>
	</xsl:template>
	
	<xsl:template match="tdoc:admonition">
	...
	<xsl:template match="tdoc:formula/tdoc:dt/tdoc:stem">
		<fo:inline>
			<xsl:apply-templates/>
		</fo:inline>
	</xsl:template>
	
	<xsl:template match="tdoc:formula/tdoc:stem">
					...
					<fo:table-row>
						...
						<fo:table-cell display-align="center">
							<fo:block text-align="right">
								<xsl:choose>
									<xsl:when test="ancestor::tdoc:annex">
										<xsl:text>(</xsl:text><xsl:number format="A.1" level="multiple" count="tdoc:annex | tdoc:formula"/><xsl:text>)</xsl:text>
									</xsl:when>
									<xsl:otherwise> <!-- not(ancestor::tdoc:annex) -->
										<!-- <xsl:text>(</xsl:text><xsl:number level="any" count="tdoc:formula"/><xsl:text>)</xsl:text> -->
									</xsl:otherwise>
								</xsl:choose>
							</fo:block>
						</fo:table-cell>
	...
	<xsl:template match="tdoc:br" priority="2">
		<!-- <fo:block>&#xA0;</fo:block> -->
		<xsl:value-of select="$linebreak"/>
	</xsl:template>
	
	<xsl:template match="tdoc:pagebreak">
		<fo:block break-after="page"/>
		<fo:block> </fo:block>
		<fo:block break-after="page"/>
	</xsl:template>
	...
	<xsl:template name="getLevel">
		...
		<xsl:variable name="level">
			<xsl:choose>
				<xsl:when test="ancestor::tdoc:preface">
					<xsl:value-of select="$level_total - 2"/>
				</xsl:when>
				<xsl:when test="ancestor::tdoc:sections">
					<xsl:value-of select="$level_total - 2"/>
				</xsl:when>
				<xsl:when test="ancestor::tdoc:bibliography">
					<xsl:value-of select="$level_total - 2"/>
				</xsl:when>
	...
	<xsl:template name="getSection">
		...
		<xsl:variable name="section">
			<xsl:choose>
					...
					<xsl:choose>
						...
						<xsl:when test="$level &gt;= 2">
							<xsl:variable name="num">
								<xsl:number format=".1" level="multiple" count="tdoc:clause/tdoc:clause | tdoc:clause/tdoc:terms | tdoc:terms/tdoc:term | tdoc:clause/tdoc:term | tdoc:clause/tdoc:definitions | tdoc:definitions/tdoc:definitions | tdoc:terms/tdoc:definitions"/>
							</xsl:variable>
				...
				<!-- <xsl:when test="ancestor::tdoc:annex[@obligation = 'informative']">
					<xsl:choose>
						<xsl:when test="$level = 1">
							<xsl:text>Annex  </xsl:text>
							<xsl:number format="I" level="any" count="tdoc:annex[@obligation = 'informative']"/>
						</xsl:when>
						<xsl:otherwise>
							<xsl:number format="I.1" level="multiple" count="tdoc:annex[@obligation = 'informative'] | tdoc:clause"/>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:when> -->
				<xsl:when test="ancestor::tdoc:annex">
					<xsl:choose>
						<xsl:when test="$level = 1">
							...
							<xsl:choose>
								<xsl:when test="count(//tdoc:annex) = 1">
									<xsl:value-of select="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:ext/tdoc:structuredidentifier/tdoc:annexid"/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:number format="A" level="any" count="tdoc:annex"/>
								</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="count(//tdoc:annex) = 1">
									<xsl:value-of select="/tdoc:tdoc-standard/tdoc:bibdata/tdoc:ext/tdoc:structuredidentifier/tdoc:annexid"/><xsl:number format=".1" level="multiple" count="tdoc:clause"/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:number format="A.1" level="multiple" count="tdoc:annex | tdoc:clause"/>
								</xsl:otherwise>
							</xsl:choose>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:when>
				<xsl:when test="ancestor::tdoc:preface"> <!-- if preface and there is clause(s) -->
					<xsl:choose>
						<xsl:when test="$level = 1 and  ..//tdoc:clause">0</xsl:when>
						<xsl:when test="$level &gt;= 2">
							<xsl:variable name="num">
								<xsl:number format=".1" level="multiple" count="tdoc:clause"/>
							</xsl:variable>
