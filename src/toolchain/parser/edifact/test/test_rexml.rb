...
class EDIFACT_REXML_Tests < Test::Unit::TestCase
  ...
  def test_rexml
    ...
    sx = File.open('in2.edi', &:read).chop
    se =
      @se.sub(
        /PRI\+AAA:30::LIU\'PRI\+AAE:99::/,
    ...
    @ice.to_xml(xdoc_e)
    xdoc_e.write(se, 0) #    xdoc_e.write( File.open('in2a.xml','w'), 0 )
  ...
  def test_groups
    ...
    sg = StringIO.new
    xdoc.write(sg, 0) #    xdoc.write( File.open("groups2.xml",'w'), 0 )
