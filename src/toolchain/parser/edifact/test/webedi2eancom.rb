...
class WebEDI_to_EANCOM02_Map_ORDERS
  ...
  def processHeader(line)
    ...
    unb.cS003.d0007 = 14 #    unb.d0035 = '1' if whatever ...
    ...
    if datum_der_bestellung.empty?
      raise 'Mandatory element missing: datum_der_bestellung'
    end
    ...
    [
      ...
      if with_rff_va # ust_id: reserved for INVOIC ?!
        unless ust_id.nil?
          rff = @msg.new_segment('RFF')
          cde = rff.cC506
          cde.d1153 = 'VA'
    ...
    [[ek, 'AAA'], [vk, 'AAE']].each do |params|
      ...
      unless preis.empty?
        ...
        if qu == 'AAA'
          ...
          cde.d5387 = 'SRP'
          cde.d5284 = preisbezugseinheit #          cde.d6411 = 'PCE' ??
        end
        @msg.add(pri)
      end
    end
  ...
  def write(hnd)
    @ic.write(hnd)
  end # Fine as long as we don't create a summary section
  ...
  EDI::E::Interchange.new(
    {
      ...
      interchange_agreement_id: 'EANCOM' + '',
      # your ref here!
      test_indicator: 1
    }
  )
