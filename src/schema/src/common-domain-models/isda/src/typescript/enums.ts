...
export enum BondClassEnum {
  ...
  /**
   * Bond: A security issued by financial institutions to count towards regulatory capital, including term and perpetual subordinated debt, contingently convertible and others.  Excludes preferred share   capital.
   */
  REG_CAP,

  /**
   * Bond: Structured – A bond with non-standard interest or principal features, with full recourse to the issuer.
   */
  STRUCTURED,
...
export enum BondInterestEnum {
  ...
  /**
   * Security: Bond Economics Interest: Calculated with reference to a floating interest rate.
   */
  FLOATING,

  /**
   * Security: Bond Economics Interest: Calculated with reference to one or more price or other indices (other than inflation rates).
   */
  INDEX_LINKED,

  /**
   * Security: Bond Economics Interest: Calculated with reference to one or more specified inflation rates.
   */
  INFLATION_LINKED,
...
export enum BondPrincipalEnum {
  ...
  /**
   * Security: Bond Economics Principal: The principal is paid all at once on maturity of the bond. Bullet bonds cannot be redeemed early by an issuer, which means they are non-callable.
   */
  BULLET,

  /**
   * Security: Bond Economics Principal: The principal on the debt can be repaid early, in whole or in part, at the option of the Issuer.
   */
  CALLABLE,

  /**
   * Security: Bond Economics Principal: The principal on the debt is calculated with reference to one or more price or other indices (other than inflation rates).
   */
  INDEX_LINKED,

  /**
   * Security: Bond Economics Principal: The principal on the debt is calculated with reference to one or more specified inflation rates.
   */
  INFLATION_LINKED,

  /**
   * Security: Bond Economics Principal: The principal on the debt is calculated with reference to other underlyings (not being floating interest rates, inflation rates or indices) or with a         non-linear relationship to floating interest rates, inflation rates or indices.
   */
  OTHER_STRUCTURED,
...
export enum BondSeniorityEnum {
  ...
  /**
   * Security: Bond Economics Seniority: Debt which ranks pari passu with all other unsecured creditors of the issuer.
   */
  SENIOR,
...
export enum EquityTypeEnum {
  ...
  /**
   * Equity type: Convertible, debt securities that can be converted primarily at the election of the holder into common shares of the Issuer
   */
  HOLDER_CONVERTIBLE,

  /**
   * Equity type: Convertible, debt securities that can be converted primarily at the election of the holder into common shares of a party other than the Issuer
   */
  HOLDER_EXCHANGEABLE,

  /**
   * Equity type: Convertible, debt securities that can be converted at the election of the Issuer into common shares of the Issuer.  Also known as reverse convertible.
   */
  ISSUER_CONVERTIBLE,
...
export enum FundProductTypeEnum {
  ...
  /**
   * Equity: Fund type: Money Market Fund – A fund that invests only in highly liquid near-term instruments such as cash, cash equivalent securities, and high credit rating debt-based             securities with a short-term, maturity
   */
  MONEY_MARKET_FUND,
...
export enum SecurityTypeEnum {
  ...
  /**
   * Security: Certificates – a security that offers a derivative-based economic return which is not structured as a bond, an equity or a warrant.
   */
  CERTIFICATE,
  ...
  /**
   * Security: Fund – Instrument representing holding in an investment fund.
   */
  FUND,
