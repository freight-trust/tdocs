				...
				(e.exports.ThemeNav = {
					...
					init: function (i) {
						...
						(this.navBar = i("div.wy-side-scroll:first")),
							...
							i("table.docutils:not(.field-list,.footnote,.citation)").wrap(
					...
					reset: function () {
						...
						try {
							var e = $(".wy-menu-vertical"),
								i = e.find('[href="' + n + '"]');
							if (0 === i.length) {
								var t = $('.document [id="' + n.substring(1) + '"]').closest(
									"div.section"
								);
								0 === (i = e.find('[href="#' + t.attr("id") + '"]')).length &&
									(i = e.find('[href="#"]'));
							}
							0 < i.length &&
					...
					onScroll: function () {
						...
						n < 0 ||
							e > this.docHeight ||
							(this.navBar.scrollTop(i), (this.winPosition = n));
					},
					onResize: function () {
						(this.winResize = !1),
					...
					"undefined" != typeof window &&
						(window.SphinxRtdTheme = { Navigation: e.exports.ThemeNav }),
					(function () {
						for (
							var r = 0, n = ["ms", "moz", "webkit", "o"], e = 0;
